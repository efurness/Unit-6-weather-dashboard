        ...
        .then(function (response) {
            if (response.ok) {
                ...
                response.json().then(function (data) {
                    ...
                    var url = "https://api.openweathermap.org/data/2.5/onecall?lat=" + lat + "&lon=" + long + "&units=imperial&exclude=hourly,minutely,alerts&appid=c8f8824f82f862c7696a070f2a1a8586";
